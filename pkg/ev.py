...
class EV:
    ...
    mpg : (float)
        The MPG of the vehicle in unit of energy per distance, ex.
        kWh/km.
    batteryCharge : (float)
    ...
    batteryCapacity : (float)
        ...
        NOT IMPLEMENTED. NOW IT IS ALWAYS ZERO WHICH MEANS THAT THE
        ELECTRIC VEHICLE HAS INFINTIE RANGE.
    trips : (int)
    ...
    def find_state(self, chain, time_step, stations, distances):
        '''Estimates the state of the electric vehilce updates the state, changes the location, occupies the new location.
