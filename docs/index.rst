...
.. autosummary::
   ...
   auxiliary.extractdistances.extract_distances
   auxiliary.extractfiles.read_matrix_files
...
This class describes what is done when the model is running. You can copy this
class and create your own class, that charges the electric vehicles if
certain conditions are met, i.e., smart charging.
...
.. automodule:: auxiliary.extractdistances
   :members:

.. automodule:: auxiliary.extractfiles
   :members:

.. automodule:: auxiliary.spatialaux
   :members:
